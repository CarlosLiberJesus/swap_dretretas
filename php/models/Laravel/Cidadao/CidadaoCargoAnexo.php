...
class CidadaoCargoAnexo
{
    ...
    public function __construct(string $uuid, string $nome, int $cidadaoCargoId, AnexoTipo $anexoTipo)
    {
        $this->uuid = $uuid;
        $this->nome = $nome;
    ...
    public static function create(array $data): self
    {
        ...
        $anexo = new self($data['uuid'], $data['nome'], $data['cidadao_cargo_id'], $anexoTipo);
    ...
    {
        return sprintf(
            "INSERT INTO cidadao_cargo_anexos (uuid, nome, cidadao_cargo_id, anexo_tipo_id, path, src, created_at, updated_at) VALUES ('%s', '%s', %d, %d, %s, %s, '%s', '%s')",
            $this->uuid,
            $this->nome,
            $this->cidadaoCargoId,
            $this->anexoTipo->id,
